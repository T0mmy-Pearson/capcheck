...
export const fetchUserById = (userId: Number)=>{
    return capCheckApi.get(`/users/${userId}`)
    .then(res=>{
...
export const fetchMushrooms = (givenParams: Object)=>{
    return capCheckApi.get("/mushroom", {params:{...givenParams}})
    .then(res=>{
...
export const fetchMushroomById = (mushroomId: Number)=>{
    return capCheckApi.get(`/mushroom/${mushroomId}`)
    .then(res=>{
        return res.data.mushroom
    })
}

export const fetchPhotos = (givenParams: Object)=>{
    return capCheckApi.get("/userphotos", {params:{...givenParams}})
    .then(res=>{
